...
```{r importing_and_merging, message=FALSE, warning=FALSE, include=FALSE}
...
## V-Dem indicators ##
  ...
  import_pandem <- read_csv("data/PanDem_ts_V5.csv")
...
skim_all_yr_2020 <- skim(df_all_yr_2020)

```

# All Data (individual dates)
