...
In index comes from the country-level amounts since the start of the pandemic, used in the following equation: (1 / COVID-19 cases per million) * (1 / COVID-19 deaths per million) * (total COVID-19 tests per thousand)
