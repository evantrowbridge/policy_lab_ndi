...
df_controls <- df_all_yr_2020 %>%
  ...
  select(
    country_standard, gdp, gini, gdp_percap, gdp_percap_ppp,
    percap_domestic_health_expenditure, percap_domestic_health_expenditure_ppp,
...
df_indices_controls <- df_transparency_index %>%
  ...
  full_join(df_budget_particpation_index[ , c("country_standard", "budget_participation_index", "incomplete_bdgt_part_index")], "country_standard") %>%
